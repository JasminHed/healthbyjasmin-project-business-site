...
const TRANSLATIONS = {
  sv: {
    ...
    booking: {
      ...
      betalning: "Betalning", betalningTitle: "Swish via Frilans Finans", betalningDesc: "Betalning sker via Swish efter behandlingen",
  ...
  en: {
    ...
    booking: {
      ...
      betalning: "Payment", betalningTitle: "Swish via Frilans Finans", betalningDesc: "Payment is made via Swish after the treatment",
