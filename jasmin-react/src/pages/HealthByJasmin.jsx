...
const TRANSLATIONS = {
  sv: {
    ...
    booking: {
      ...
      betalning: "Betalning", betalningTitle: "Swish via Frilans Finans", betalningDesc: "Betalning sker via Swish och skickas innan behandling",
      ...
      rowPlats: "Plats", rowBetalning: "Betalning", rowFaktura: "Swish via Frilans Finans",
  ...
  en: {
    ...
    booking: {
      ...
      betalning: "Payment", betalningTitle: "Swish via Frilans Finans", betalningDesc: "Payment is made via Swish and sent before the treatment",
      ...
      rowPlats: "Location", rowBetalning: "Payment", rowFaktura: "Swish via Frilans Finans",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How is payment handled?", a: "Payment is made via Swish through Frilans Finans after the completed treatment." },
      ...
      <main>
        ...
        <section className="retreat-section">
          <article className="retreat">
            <img src="/assets/yogasal.jpg" alt="Yogasal för stadsretreat" />
