...
const TRANSLATIONS = {
  sv: {
    ...
    faq: {
      ...
      items: [
        { q: "Var befinner ni er?", a: "Vi håller till i Vasastan, Stockholm. Exakt adress är Birkagatan 23." },
        ...
        { q: "Kan man delta i yoga direkt efter en massagebehandling?", a: "Absolut, du är välkommen på både ayurveda och yoga samma dag. Tänk på att dusch krävs efter massagebehandlingen innan du deltar i yogaklassen." },
        ...
        { q: "Vilken massage ska jag välja?", a: "Välj den behandling du känner att du har behov av. Abhyanga fokuserar på djup återhämtning och vila, medan Vishesh riktar sig mer mot spänningar och balans." },
        { q: "Hur bokar jag yoga?", a: "Yin Yoga bokas via Home in Yoga. Du hittar bokningslänken direkt i bokningssektionen nedan." },
        { q: "Hur betalas behandlingen?", a: "Betalning sker via Frilans Finans och du faktureras efter genomförd behandling." },
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        { q: "Where are you located?", a: "We are based in Vasastan, Stockholm. The exact address is Birkagatan 23." },
        ...
        { q: "Can I attend yoga directly after a massage?", a: "Absolutely, you are welcome to do both ayurveda and yoga on the same day. Please note that a shower is required after the massage treatment before joining the yoga class." },
        ...
        { q: "How do I book yoga?", a: "Yin Yoga is booked via Home in Yoga. You will find the booking link directly in the booking section below." },
        { q: "How is payment handled?", a: "Payment is made via Frilans Finans and you will be invoiced after the completed treatment." },
